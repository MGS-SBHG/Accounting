...
public class TroubledDebtSettlements {
   ...
   CREDITOR: record interest revenue; amortization of discount on N/R
    ...
    /*
    allowance for doubtful acccounts
    --------------------------------------
                    |   12/31/x4    33.057
                    |   12/31/x5    3305
                    |   12/31/x6    3638
...
ASC 310-10-50-15 RECEIVABLES, OVERALL DISCLOUSRES, IMPAIRED LOANS
SFAS NO 118 ACCOUNTING BY CREDITORS FOR IMPAIRMENT OF A LOAN-INCOME RECOGNITION AND DISCLOUSRES
    AMENDMENT TO FASB STATEMENT NO. 114

    NOTES RECEIVABLE (IMPAIRED LOANS)
        N/R WITH ALLOWANCE ACCOUNT
        N/R W/O  ALLOANCE ACCOUNT
